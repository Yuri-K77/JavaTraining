package operators.TransitionOperators;/* Оператор break позволяет прервать выполнение цикла в любой удобный момент - раньше, чем цикл "должен был бы" завершиться.
Основные моменты:
